...
<html>
    <head>
        ...
        <meta http-equiv="Refresh" content="0; url=/Money_Mode_Exchange_System/jsp/ADMIN.jsp">
    ...
    <body>
        ...
        pst=con.prepareStatement("update users set valid=\"YES\" where st_id=?");
			...
			if(x==1)
			{
                        ...
                        pst1.setString(3,"Validated a User");
                        int x1=pst1.executeUpdate();
			}
		}
                catch(Exception x)
		{
			out.println("please check the data "+x.getMessage());
		}
