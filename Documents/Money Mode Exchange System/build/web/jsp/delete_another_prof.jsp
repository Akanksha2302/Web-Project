...
<html>
    <head>
        ...
        <meta http-equiv="Refresh" content="3; url=/Money_Mode_Exchange_System/jsp/ADMIN.jsp">
    ...
    <body>
        <% 
            ...
            ps2=con.prepareStatement("delete from exchange_request_inactive where st_id="+target+";");
