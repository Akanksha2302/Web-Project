...
<html>
	...
	<link rel="Stylesheet" type="text/css" href="/Money_Mode_Exchange_System/css/style.css" >
		...
		<div>
			<ul>
				<li><a href="deleteprofile.jsp" onclick="return conf()">Delete Profile</a></li>
                                ...
                                <li><a href="/Money_Mode_Exchange_System/request_reg_form.html">Register an exchange request</a></li>
