...
<html>
    ...
    <body>
        <% 
            ...
            {
                ps=con.prepareStatement("delete from exchange_request_active where req_no="+req_num+" && st_id="+sess_un+";");
            }
        try{
            ...
            if(x==1)
            {
                ...
                response.sendRedirect("/Money_Mode_Exchange_System/jsp/view_requests.jsp");
            }
            if(x==0)
            {
                out.println("<h1>ERROR : CAN'T DELETE OTHER USERS REQUEST</h1>");
            }
        }
        catch(Exception e)
        {
